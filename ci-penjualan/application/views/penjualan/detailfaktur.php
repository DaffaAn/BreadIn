...
<div class="row mt-3">
  <div class="card">
    ...
    <div class="card-body">
      <a href="#" class="btn btn-success mb-3" id="bayar"><i class="fa fa-money"> Bayar</i></a>
        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td>
                <a href="#" data-href="<?php echo base_url(); ?>penjualan/hapusbayar/<?php echo $b->nobukti; ?>/<?php echo $penjualan['no_faktur']; ?>" class="btn btn-danger btn-sm hapus"><i class="fa fa-trash-o"></i></a>
              </td>
            </tr>
          <?php $no++;
          } ?>
  ...
  <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="#" id="hapusbayar" class="btn btn-danger">Yes, delete</a>
      </div>
    </div>
  </div>
</div>
