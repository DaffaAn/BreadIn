...
class Penjualan extends CI_Controller
{
    ...
    function index($rowno = 0)
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            $namapelanggan = $this->input->post('namapelanggan$namapelanggan');
            ...
            if ($this->session->userdata('sampai') != NULL) {
                $sampai = $this->session->userdata('no_faktur');
            }
        }
        $rowperpage = 5;
        // Row position
    ...
    function inputpenjualan()
    {
        ...
        $nomorterakhir = isset($getLastFaktur['no_faktur']) ? $getLastFaktur['no_faktur'] : '';
