            ...
            <div class="card-body">
                <form action="<?php echo base_url(); ?>penjualan/cetaklaporanpenjualan" method="POST">
                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-md-6">
                                <button type="submit" name="submit" class="btn btn-primary w-100"><i class="fa fa-search mr-2"></i> Cetak </button>
                            </div>
                            <div class="col-md-6">
                                <button type="submit" name="export" class="btn btn-success w-100"><i class="fa fa-down;oad mr-2"></i> Export Excel </button>
                            </div>
                        </div>
                    </div>
                </form>
