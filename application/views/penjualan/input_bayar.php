<form method="POST" action="<?php echo base_url(); ?>penjualan/simpanbayar">
    ...
    <div class="mb-3">
        <button type="submit" class="btn btn-primary w-100"><i class="fa fa-send mr-2"></i> BAYAR</button>
    </div>
</form>
    ...
    $(function() {
        $("#formBayar").submit(function() {
            ...
            if (jmlbayar == "" || jmlbayar == 0) {
                ...
                swal("Oops !", "Jumlah Bayar Tidak Boleh Melebihi Sisa Bayar, Sisa Bayar Anda Adalah " + sisabayar, "warning");
                return false;
            } else {
                return true;
            }
